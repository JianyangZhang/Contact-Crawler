...
public class SalesgenieDAO {
	...
	public static void insert(String sg_person_name, String sg_phone_number, String sg_company_name, String sg_street, String sg_city, String sg_state, String sg_zipcode) {
