...
public class LaunchWindow extends JFrame {
	...
	public static void main(String[] args) {
		LaunchWindow loginWindow = new LaunchWindow();
	}
	...
	public LaunchWindow() {
		...
		JLabel label_intro = new JLabel("<html><font color='red'>The account you are using to crawl emails may get banned</font><html>");
	...
	/**
	 * change status text
	 * flag: 0-pending 1-running 2-done 3-failed 
	 **/
